...
export function DesignPanel() {
  ...
  return <section className="panel"><h2>Diseño</h2>
    ...
    <div className="design-adjustment-grid">{slider('Tamaño', 'scale', 0.2, 2.5, .01, true)}{slider('Horizontal', 'x', -0.8, 0.8)}{slider('Vertical', 'y', -0.9, 0.9)}{slider('Rotación', 'rotation', -180, 180, 1)}{slider('Integración con tela', 'integration', 35, 100, 1)}</div>
